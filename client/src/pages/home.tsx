...
export default function Home() {
    ...
    onSuccess: (data) => {
      if (data.alreadySubscribed) {
        ...
        toast({
          ...
          description: "You'll receive updates about our AI calling agent.",
          variant: "default",
        });
      }
      setEmail("");
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative overflow-hidden bg-gradient-to-br from-slate-50 via-gray-50 to-white dark:from-slate-950 dark:via-gray-900 dark:to-black">
      ...
      {/* Main Content */}
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-6 sm:space-y-8 pt-20 sm:pt-24">
        {/* Hero Section */}
        <div className="space-y-4 sm:space-y-6">
          {/* Business Badge */}
          <div className="inline-flex items-center space-x-2 bg-blue-50 dark:bg-blue-950/50 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-lg shadow-sm border border-blue-200 dark:border-blue-800 animate-reveal-scale opacity-0" style={{ animationDelay: "0.2s", animationFillMode: "both" }}>
            <TrendingUp className="h-4 w-4 text-blue-600 dark:text-blue-400" />
            <span className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300">Trusted by 500+ Businesses</span>
          </div>
          
          <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight tracking-tight px-2 sm:px-0">
            <span className="block text-gray-900 dark:text-white mb-2 animate-reveal-up opacity-0" style={{ animationDelay: "0.3s", animationFillMode: "both" }}>Enterprise AI</span>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 font-medium max-w-3xl mx-auto leading-relaxed px-2 sm:px-4 animate-reveal-up opacity-0" style={{ animationDelay: "0.5s", animationFillMode: "both" }}>
            Automate your sales outreach, customer support, and appointment scheduling with Ruka's intelligent AI calling system.
            <span className="block mt-3 text-sm sm:text-base lg:text-lg text-gray-700 dark:text-gray-400 flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 animate-reveal-up opacity-0" style={{ animationDelay: "0.6s", animationFillMode: "both" }}>
              <span className="flex items-center space-x-1 transition-smooth hover:text-blue-600">
        ...
        <div className="animate-reveal-up hover-lift opacity-0" style={{ animationDelay: "0.7s", animationFillMode: "both" }}>
          <Card className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 sm:p-8 rounded-2xl shadow-2xl max-w-md mx-4 sm:mx-auto border-0 relative overflow-hidden transition-smooth">
            {/* Decorative elements */}
            ...
            <div className="text-center space-y-4 sm:space-y-6 relative z-10">
              ...
              <div className="relative inline-block">
                <div className="bg-white/10 backdrop-blur-sm w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center mx-auto ring-2 ring-white/20">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="inline-flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full">
                  ...
                  <p className="text-xs font-semibold text-white uppercase tracking-wider">ROI Guaranteed</p>
                </div>
                <p className="text-white text-xl sm:text-2xl font-bold px-2">
                  Transform Your Sales Process
                </p>
                <p className="text-white/90 text-sm px-2">
                  Join 500+ companies using AI to scale their operations
                </p>
              </div>
              ...
              <Button 
                ...
                className="w-full bg-white text-blue-700 font-bold py-4 sm:py-5 px-6 sm:px-8 rounded-xl hover:bg-gray-50 transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-xl text-base sm:text-lg group"
        ...
        {/* Email Section */}
        <div className="animate-reveal-up hover-lift max-w-md mx-4 sm:mx-auto opacity-0" style={{ animationDelay: "0.9s", animationFillMode: "both" }}>
          <Card className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 relative overflow-hidden hover:border-blue-300 dark:hover:border-blue-600 transition-smooth">
              ...
              >
                {emailSubscriptionMutation.isPending ? (
                  ...
                  <>
                    ...
                    <span className="hidden xs:inline">Successfully Subscribed</span>
                    <span className="xs:hidden">Subscribed</span>
                  </>
                ) : (
                  <>
                    <Bell className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="hidden sm:inline">Get Business Updates</span>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 text-center mt-3">
              Stay informed about new business features and integrations
            </p>
          </Card>
        </div>

        {/* Feature Highlights */}
        <div className="pt-6 sm:pt-8 pb-16 sm:pb-24 px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover-lift hover:border-blue-300 dark:hover:border-blue-600 transition-smooth animate-reveal-up opacity-0" style={{ animationDelay: "1.1s", animationFillMode: "both" }}>
              <div className="flex flex-col items-center space-y-1.5 sm:space-y-2">
                <div className="bg-blue-50 dark:bg-blue-900/30 p-2 sm:p-3 rounded-xl">
                  <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-400" />
                </div>
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300 text-center">Lead Qualification</span>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover-lift hover:border-blue-300 dark:hover:border-blue-600 transition-smooth animate-reveal-up opacity-0" style={{ animationDelay: "1.2s", animationFillMode: "both" }}>
              <div className="flex flex-col items-center space-y-1.5 sm:space-y-2">
                ...
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300 text-center">Appointment Booking</span>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover-lift hover:border-blue-300 dark:hover:border-blue-600 transition-smooth animate-reveal-up opacity-0" style={{ animationDelay: "1.3s", animationFillMode: "both" }}>
              <div className="flex flex-col items-center space-y-1.5 sm:space-y-2">
                ...
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300 text-center">CRM Integration</span>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover-lift hover:border-blue-300 dark:hover:border-blue-600 transition-smooth animate-reveal-up opacity-0" style={{ animationDelay: "1.4s", animationFillMode: "both" }}>
              <div className="flex flex-col items-center space-y-1.5 sm:space-y-2">
                ...
                <span className="text-xs font-medium text-gray-700 dark:text-gray-300 text-center">Follow-up Calls</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative mt-6 sm:mt-8 pt-6 sm:pt-8 text-center z-10 border-t border-gray-200/50 dark:border-gray-700/50 px-4">
          <div className="space-y-2">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              © 2025 Ruka Business Solutions<span className="hidden sm:inline"> • Enterprise AI Calling Platform</span>
            </p>
            <a 
